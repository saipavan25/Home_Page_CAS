<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="WebPage.WebForm2" %>
   ...
   <!-- <form id="form1" runat="server">-->
    ...
    <div class="w3-container">-->
        <div id="id01" class="w3-modal">
            <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:500px">
             ...
             <form class="w3-container" action="/action_page.php">
                    <div class="w3-section">
                        ...
                        <button class="w3-button w3-block w3-teal w3-section w3-round-large w3-padding" type="submit" id="InnerLogin" onclick="InnerLogin_Click">Login</button>
         ...
         <button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-teal w3-large"style="width:20%" id="login">Login</button>
    </div>
